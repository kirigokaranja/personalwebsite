			...
			<div class="row">
				<div class="col-xl-10 offset-xl-1">
					<div class="row">
						<div class="col-lg-6">
							<div class="hero-text">
								<h2>Kirigo Karanja</h2>
								<p>I’m a web developer who loves learning new things and travelling the world.</p>
							</div>
							<div class="hero-info">
								<h2>General Info</h2>
								<ul>
									<li><span>Date of Birth</span>Oct 11, 1997</li>
									<li><span>Address</span>Thika, KE</li>
									<li><span>E-mail</span>sharonkirigo@gmail.com</li>
									<li><span>Phone </span>+254713774575</li>
								</ul>
							</div>
						</div>
						<div class="col-lg-6">
			...
			<div class="row">
				<div class="col-xl-7 offset-xl-2">
					...
					<ul class="resume-list">
						<li>
							<h2>2016</h2>
							<h3>Moi Primary School Thika</h3>
							<h4>Secretary</h4>
							<p> After finishing high school I got hands on experienced by working as a secretary where I prepared minutes for meetings
								and welcomed the visitors who came to the school</p>
						</li>
					<!--	<li>
							<h2>2014-2016</h2>
			...
			<div class="row">
				<div class="col-xl-7 offset-xl-2">
					...
					<ul class="resume-list">
						<li>
							<h2>2016-Present</h2>
							<h3>BSc. Informatics and Computer Science</h3>
				...
				<div class="col-xl-7 offset-xl-2">
					...
					<ul class="resume-list">
						<li>
							<h2>2017</h2>
							<h3>ILab Africa</h3>
							<h4>	Data scientist mastery award for students </h4>
